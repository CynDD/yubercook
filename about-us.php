                    ...
                    <div class="col-md-6">
                        <div class="mu-about-us-right">
                            <ul class="mu-abtus-slider">
                                <li><img src="theme/basic/assets/img/about-us/abtus-img-1.png" alt="img"></li>
                                <li><img src="theme/basic/assets/img/about-us/abtus-img-2.png" alt="img"></li>
                                <li><img src="theme/basic/assets/img/about-us/abtus-img-6.png" alt="img"></li>
                                <li><img src="theme/basic/assets/img/about-us/abtus-img-4.png" alt="img"></li>
                                <li><img src="theme/basic/assets/img/about-us/abtus-img-5.png" alt="img"></li>
                            </ul>
                        </div>
                    </div>
                </div>
