		...
		<div class="col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6">
    	 <div class="well profile">
	        ...
	        <a class="pull-left" href="#">
	          <img class="media-object img-circle"   src="Images/unknown-profileX.jpg" />
	        </a>
	        <div class="media-body">
	            <h4 class="media-heading">Victoria</h4>
	          <p>
	              Me encanto.
	          </p>
	            </div>
	      ...
	      <li class="media">
	        <a class="pull-left" href="#">
	          <img class="img-circle img-responsive"   src="Images/unknown-profileX.jpg" />
	        </a>
	        <div class="media-body">
	       ...
	       <li class="media">
	        ...
	        <div class="media-body">
	            <h4 class="media-heading">Manu</h4>
	          <p>
	              Las mejores empanadas las hace el Yubi.
	          </p>
	            </div>
	                            </li>
