...
<div class="mu-slider-area">
    ...
    <div class="mu-top-slider">
        ...
        <div class="mu-top-slider-single">
            <img src="theme/basic/assets/img/slider/cenainicio.jpg" alt="img">
            <!-- Top slider content -->
        ...
        <!-- Top slider single slide -->
        <div class="mu-top-slider-single">
            <img src="theme/basic/assets/img/slider/ensaladas.jpg" alt="img">
            <!-- Top slider content -->
            <div class="mu-top-slider-content">
        ...
        <!-- Top slider single slide -->
        <div class="mu-top-slider-single">
            <img src="theme/basic/assets/img/slider/foodheader.jpg" alt="img">
            <!-- Top slider content -->
            <div class="mu-top-slider-content">
